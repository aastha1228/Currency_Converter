	...
	public void defaultValues() {
		...
		switch (currency) {
			case "US Dollar":
				...
				this.exchangeValues.put("INR", 82.29);
				break;
			case "Euro":
				...
				this.exchangeValues.put("INR", 88.50);
				break;
			case "British Pound":
				...
				this.exchangeValues.put("INR", 95.40);
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("INR", 82.58);
				break;
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("INR", 0.088);
				break;
			case "Japanese Yen":
				...
				this.exchangeValues.put("INR", 1.79);
				break;
			case "Indian Rupee":
				this.exchangeValues.put("USD", 0.012);
				this.exchangeValues.put("EUR", 0.011);
				this.exchangeValues.put("GBP", 0.0105);
				this.exchangeValues.put("CHF", 0.0118);
